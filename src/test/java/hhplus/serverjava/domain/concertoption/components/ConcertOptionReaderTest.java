...
public class ConcertOptionReaderTest {
    ...
    void findConcertOptionListEmptyTest() {
        ...
        //when & then
        BaseException exception = assertThrows(BaseException.class, () -> concertOptionReader.findConcertOptionList(concertOptionId));
    ...
    void findConcertOptionTest() {
        ...
        when(concertOptionReaderRepository.findConcertOption(concertOptionId, testDateTime)).thenReturn(Optional.of(concertOption));
    ...
    void findConcertOptionNotFoundTest() {
        ...
        // when & then
        BaseException exception = assertThrows(BaseException.class, () -> concertOptionReader.findConcertOption(concertOptionId, testDateTime));
        assertEquals(NOT_FOUND_CONCERT_OPTION.getMessage(), exception.getMessage());
    }
